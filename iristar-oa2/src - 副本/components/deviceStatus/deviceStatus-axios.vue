<template>
  <div class="deviceStatus" v-loading.fullscreen="loading">
    ...
    <div class="setting-device" v-show="showSettingDevice">
      ...
      <W200 @returnTitle="getW200Title" @saveData="saveData" :deviceData="deviceData" v-if="deviceTag === 'W200'"></W200>
      <S300 @returnTitle="getW200Title" :deviceData="deviceData" v-if="deviceTag === 'S300'"></S300>
      <S320 @returnTitle="getW200Title" @saveData="saveData" :deviceData="deviceData" v-if="deviceTag === 'S320'"></S320>
    </div>
  </div>
</template>
<script>
