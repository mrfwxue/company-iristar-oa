          ...
          <div class="item">
            ...
            <div class="inner w-100">
              <div class="upload-wrap">
                <i v-show="s320Set.logo" @click="()=>{handleClearFile('s320Set', 'logo')}" class="el-icon-circle-close upload-close-file"></i>
                <input type="file" ref="logo" data-name="logo" @change="(e)=>{handleImportExcelFile(e, 's320Set')}">
                <input type="text" v-model="s320Set.logo">
                <el-button round size="mini" type="primary">{{$t('message.INPUT.choose')}}<i v-show="s320Set.logo" class="el-icon-check el-icon--right"></i></el-button>
              </div>
      ...
      <div class="item" style="margin-top:10px;">
        ...
        <div class="inner-wrap" v-show="s320Set.workMode=='4'">
          <div class="item">
            ...
            <div class="input w-200">
              <el-date-picker
                v-model="s320Set.startDay"
    ...
    handleImportExcelFile(e, formName) {
      ...
      if(ele.files.length === 0){
        ...
        reader.onload = function () {
          vm[formName][name] = reader.result;
        }
      }
    },
    // 清除文件
