    ...
    <div class="param-setting">
      ...
      <div class="item">
        ...
        <div class="inner w-100">
          <el-input type="text" size="mini" :placeholder="$t('message.INPUT.input')" clearable v-model="w200Set.model.face.yuzhi" autocomplete="off"></el-input>
      ...
      <div class="item">
        ...
        <div class="inner w-100">
          <el-input type="text" size="mini" :placeholder="$t('message.INPUT.input')" clearable v-model="w200Set.model.eye.yuzhi" autocomplete="off"></el-input>
